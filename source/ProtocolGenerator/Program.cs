...
namespace MasterDevs.ChromeDevTools.ProtocolGenerator
{
    internal class Program
    {
        ...
        private static void WriteProperty(StringBuilder sb, string domain, string className, Property property)
        {
            ...
            var description = property.Description ?? propertyName;
            sb.AppendLine("\t\t/// <summary>");
            sb.AppendFormat("\t\t/// Gets or sets {0}", description.Replace("\r\n", " ").Replace("\n", " "));
            sb.AppendLine();
            sb.AppendLine("\t\t/// </summary>");
        ...
        private static void WriteTypeEnum(DirectoryInfo domainDirectoryInfo, string ns, Type type)
        {
            ...
            sb.AppendLine("{");
            sb.AppendLine("\t/// <summary>");
            sb.AppendFormat("\t/// {0}", type.Description != null ? type.Description.Replace("\r\n", " ").Replace("\n", " ") : "");
            sb.AppendLine();
            sb.AppendLine("\t/// </summary>");
