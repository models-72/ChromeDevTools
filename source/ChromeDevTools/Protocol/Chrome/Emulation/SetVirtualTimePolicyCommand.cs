...
namespace MasterDevs.ChromeDevTools.Protocol.Chrome.Emulation
{
	...
	public class SetVirtualTimePolicyCommand: ICommand<SetVirtualTimePolicyCommandResponse>
	{
		...
		/// <summary>
		/// Gets or sets If set the virtual time policy change should be deferred until any frame starts navigating. Note any previous deferred policy change is superseded.
		/// </summary>
		[JsonProperty(NullValueHandling = NullValueHandling.Ignore)]
